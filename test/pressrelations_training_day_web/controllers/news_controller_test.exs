defmodule PressrelationsTrainingDayWeb.NewsControllerTest do
  use PressrelationsTrainingDayWeb.ConnCase
  ...
  @create_attrs %{
    date: ~U[2022-03-20 13:21:00.000000Z],
    headline: "some headline",
    publication: "some publication",
    text: "some text"
  }
  @update_attrs %{
    date: ~U[2022-03-21 13:21:00.000000Z],
  ...
  describe "create news" do
    test "renders news when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "date" => "2022-03-20T13:21:00.000000Z",
               "headline" => "some headline",
               "publication" => "some publication",
               "text" => "some text"
  ...
  describe "update news" do
    ...
    test "renders news when data is valid", %{conn: conn, news: %News{id: id} = news} do
      ...
      assert %{
               "id" => ^id,
               "date" => "2022-03-21T13:21:00.000000Z",
               "headline" => "some updated headline",
               "publication" => "some updated publication",
               "text" => "some updated text"
             } = json_response(conn, 200)["data"]
